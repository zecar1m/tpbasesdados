...
-- Query 6: Lista todas as viaturas em missão por epcs
...
-- Query 7: Determinar o intervalo entre as inspecoes marcadas e comparar com o intervalo de inspecao especido para cada equipamento
...
-- Query 8: Listar as viaturas com os tipos de equipamentos e quantidades existentes
...
-- Query 9: Listar todas as viaturas por tipos de missao
...
-- Query 10: Visualizar os profissionais por categoria e atividade
...
-- Query 11: Visualizar os pacientes assistidos por tipo de missão
...
-- Query 12: Listar missões por tipo de missao e atividade
...
-- Query 13: Determinar a quantidade de profissionais, por missao e categoria 
